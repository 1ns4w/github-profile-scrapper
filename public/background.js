...
(() => {
  ...
  // dist/modules/services/connection.js
  var require_connection = __commonJS({
    "dist/modules/services/connection.js"(exports) {
      "use strict";
      ...
      exports.db = void 0;
      var dexie_1 = __importDefault((init_dexie(), __toCommonJS(dexie_exports)));
      exports.db = new dexie_1.default("ghps");
      ...
      chrome.runtime.onConnect.addListener((port) => {
        if (port.name === "safePort") {
          port.onMessage.addListener(async (message) => {
            await connection_1.db.table("user").add(message);
            console.log(message);
          });
        }
      });
